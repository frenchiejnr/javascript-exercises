...
describe('leapYears', function() {
  it('works with non century leap years', function() {
    expect(leapYears(1996)).toEqual(true);
  });
  it('works with non century non-leap years', function() {
    expect(leapYears(1997)).toEqual(false);
  });
  it('works with ridiculously futuristic non century years', function() {
    expect(leapYears(34992)).toEqual(true);
  });
  it('works with century years that are not leap years', function() {
    expect(leapYears(1900)).toEqual(false);
  });
  it('works with century years that are leap years', function() {
